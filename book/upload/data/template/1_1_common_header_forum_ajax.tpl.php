...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1422362272, '1', './data/template/1_1_common_header_forum_ajax.tpl.php', './template/default', 'common/header_forum_ajax')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1422362272, '1', './data/template/1_1_common_header_forum_ajax.tpl.php', './template/default', 'common/header_forum_ajax')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1422362272, '1', './data/template/1_1_common_header_forum_ajax.tpl.php', './template/default', 'common/header_forum_ajax')
;?>
